...
class Practice7ClassQuotesFragment : Fragment(), MainView {
    ...
    override fun onResume() {
        super.onResume()
        progressbar.visibility = View.INVISIBLE
        presenter.getClassQuotes(BuildConfig.CLASS_ID)
    }

    private lateinit var presenter: MainPresenter
    private var students: MutableList<Student> = mutableListOf()
    private var quotes: MutableList<Quote> = mutableListOf()
    private lateinit var adapter: Practice7ClassQuotesAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = Practice7ClassQuotesAdapter(quotes, activity!!)
        ...
        adapter.setOnItemClickCallback(object : Practice7ClassQuotesAdapter.OnItemClickCallback {
