...
class Practice7ClassQuotesAdapter(private val list: MutableList<Quote>, val context: Context) :
    RecyclerView.Adapter<Practice7ClassQuotesAdapter.BookViewHolder>() {
