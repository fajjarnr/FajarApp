...
class Practice7MyQuotesAdapter(private val list: List<Quote>, val context: Context) :
    RecyclerView.Adapter<Practice7MyQuotesAdapter.BookViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BookViewHolder {
        val view: View = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_quote_practice7, parent, false)
